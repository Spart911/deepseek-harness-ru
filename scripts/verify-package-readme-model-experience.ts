...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-settings-plugin-inventory': { kind: 'none', reason: 'Browser-side inventory projection with enablement toggles; registers nothing model-facing.' },
  ...
  'packages/host/plugin-inventory': { kind: 'none', reason: 'Host-side Loader projection and enablement mutation; registers nothing model-facing.' },
